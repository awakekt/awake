...
package io.github.ronjunevaldoz.awake.asset.shaderpack

import kotlin.test.Test
import io.github.ronjunevaldoz.awake.render.renderer.MAX_POINT_LIGHTS
...
class UniformLayoutsTest {
    ...
    @Test
    fun litShadowUniformLayoutTotalIsOneHundred() {
        assertEquals(100, LitShadowUniformLayout.total)
    }
