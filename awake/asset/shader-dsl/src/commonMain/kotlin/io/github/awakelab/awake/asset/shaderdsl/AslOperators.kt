...
fun column(matrix: AslExpr, index: Int): AslExpr {
    ...
    if (ref.type != AslType.Data(io.github.awakelab.awake.core.geometry.GpuDataShape.Mat4)) {
        throw AslDefinitionException("column() needs a Mat4, got ${'$'}{ref.type}.")
    }
    return AslIndex(ref.wgslName, AslLiteral(index.toFloat(), AslType.I32), io.github.awakelab.awake.core.geometry.GpuDataShape.Vec4)
}
