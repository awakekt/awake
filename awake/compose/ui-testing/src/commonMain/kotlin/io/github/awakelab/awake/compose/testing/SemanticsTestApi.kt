...
fun ComposeComponentFrame.rasterizeLayoutOverlay(
    ...
    fun drawTree(nodes: List<io.github.awakelab.awake.compose.ui.node.LayoutNode>) {
        nodes.forEach { node ->
            val color = DEBUG_COLORS[index++ % DEBUG_COLORS.size]
            pixels.drawOutline(
                width,
...
class ComposeTestSession internal constructor(
    ...
    density: Float,
    private val content: context(io.github.awakelab.awake.compose.runtime.Composer) () -> Unit,
) {
...
fun composeTestSession(
    ...
    height: Int = 600,
    density: Float = 1f,
    content: context(io.github.awakelab.awake.compose.runtime.Composer) () -> Unit,
