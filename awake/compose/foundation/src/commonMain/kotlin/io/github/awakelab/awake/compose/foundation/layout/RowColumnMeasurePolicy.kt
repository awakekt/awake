...
import io.github.awakelab.awake.compose.ui.layout.LastBaseline
...
import io.github.awakelab.awake.compose.ui.layout.VerticalAlignmentLine
...
internal class VerticalAlignElement(
    ...
    override fun update(node: VerticalAlignNode) { node.alignment = alignment }
}
...
internal class HorizontalAlignElement(
    ...
    override fun update(node: HorizontalAlignNode) { node.alignment = alignment }
}
...
internal class AlignmentLineElement(
    ...
    override fun update(node: AlignmentLineNode) { node.alignmentLine = alignmentLine }
}
