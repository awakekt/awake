...
import io.github.awakelab.awake.compose.foundation.layout.FlexBox
import io.github.awakelab.awake.compose.foundation.layout.FlexDirection
import io.github.awakelab.awake.compose.foundation.layout.FlexWrap
import io.github.awakelab.awake.compose.foundation.layout.flex
...
class FlexBoxTest {
    ...
    private fun nodes(content: context(Composer) () -> Unit): Map<String, SemanticsNode> {
        ...
        fun collect(values: List<SemanticsNode>) { values.forEach { all += it; collect(it.children) } }
        collect(frame.semantics)
        return all.filter { it.testTag != null }.associateBy { it.testTag!! }
    }

    context(_: Composer)
    private fun io.github.awakelab.awake.compose.foundation.layout.FlexBoxScope.item(
        tag: String,
        main: io.github.awakelab.awake.compose.ui.unit.Dp,
