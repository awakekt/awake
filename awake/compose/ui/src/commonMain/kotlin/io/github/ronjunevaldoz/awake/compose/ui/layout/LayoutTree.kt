...
private fun LayoutNode.layoutLayers(viewport: Constraints) {
    for (i in layers.indices) {
        ...
        // Placed at its declaring node's origin. Real anchoring -- offsetting to an anchor's
        // resolved bounds, flipping when it would leave the viewport -- lands with the frame loop.
        layer.placeAt(0, 0)
