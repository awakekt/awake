...
class ComposeHost(
    ...
    layoutDirection: io.github.awakelab.awake.compose.ui.unit.LayoutDirection =
    ...
    var layoutDirection: io.github.awakelab.awake.compose.ui.unit.LayoutDirection = layoutDirection
        set(value) {
            field = value
    ...
    private fun compose(content: context(Composer) () -> Unit, input: FrameInput): Composer =
        composition.compose {
            ...
            CompositionLocalProvider(
                ...
                io.github.awakelab.awake.compose.ui.unit.LocalLayoutDirection provides layoutDirection,
                content = content,
            )
        }
