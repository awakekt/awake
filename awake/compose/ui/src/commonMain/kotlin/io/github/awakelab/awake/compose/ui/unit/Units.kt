...
import io.github.awakelab.awake.core.math2d.Dp as GraphicsDp
import io.github.awakelab.awake.core.math2d.Sp as GraphicsSp

/**
 * One import surface for the engine's units, matching Compose's `androidx.compose.ui.unit`.
 *
 * These are aliases, not new types: `Dp` here **is** `io.github.awakelab.awake.core.math2d.Dp`, so
 ...
 * compose engine at all. Aliasing here also means the planned `io.github.awakelab.*` package rename
