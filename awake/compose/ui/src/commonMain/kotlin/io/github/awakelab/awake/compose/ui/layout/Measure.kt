...
interface PlacementScope {
    ...
    val parentLayoutDirection: io.github.awakelab.awake.compose.ui.unit.LayoutDirection
        get() = io.github.awakelab.awake.compose.ui.unit.LayoutDirection.Ltr

    fun Placeable.placeRelativeAt(x: Int, y: Int) {
        val targetX = if (parentLayoutDirection == io.github.awakelab.awake.compose.ui.unit.LayoutDirection.Ltr) {
            x
        } else {
            parentWidth - width - x
        }
...
interface MeasureScope : Density {
    val layoutDirection: io.github.awakelab.awake.compose.ui.unit.LayoutDirection
        get() = io.github.awakelab.awake.compose.ui.unit.LayoutDirection.Ltr
