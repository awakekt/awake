...
internal class PaintScope : DrawScope, LayerDrawScope {
    ...
    override var layoutDirection: io.github.awakelab.awake.compose.ui.unit.LayoutDirection =
    ...
    override fun drawLayer(
        ...
        val outline = shape.createOutline(
            io.github.awakelab.awake.core.math2d.Size2D(layerWidth.toFloat(), layerHeight.toFloat()),
            density,
        )
