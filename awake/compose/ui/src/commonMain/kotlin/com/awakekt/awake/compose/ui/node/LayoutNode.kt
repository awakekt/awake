...
class LayoutNode(
    ...
    var layoutDirection: com.awakekt.awake.compose.ui.unit.LayoutDirection =
    ...
    /** Optional viewport-aware placement supplied by [com.awakekt.awake.compose.ui.layout.Layer]. */
    ...
    private val nestedScrollNodes =
        ArrayList<com.awakekt.awake.compose.ui.input.nestedscroll.NestedScrollConnection>()
    ...
    internal var nestedScrollConnections:
        List<com.awakekt.awake.compose.ui.input.nestedscroll.NestedScrollConnection> = emptyList()
        private set
    ...
    private fun rebuildChain() {
        ...
        modifier.foldIn(Unit) { _, declaredElement ->
            ...
            if (element is com.awakekt.awake.compose.ui.input.nestedscroll.NestedScrollNode) {
    ...
    private inner class NodeMeasureScope :
        ...
        override val layoutDirection: com.awakekt.awake.compose.ui.unit.LayoutDirection
            get() = this@LayoutNode.layoutDirection
        override val parentLayoutDirection: com.awakekt.awake.compose.ui.unit.LayoutDirection
            get() = this@LayoutNode.layoutDirection
