...
import com.awakekt.awake.compose.ui.layout.layout
import com.awakekt.awake.compose.ui.layout.layoutId
...
import com.awakekt.awake.compose.ui.semantics.clearAndSetSemantics
...
class FocusTargetTest {
    ...
    fun itCanTakeFocus() {
        ...
        val owner = com.awakekt.awake.compose.ui.focus.FocusOwner()
...
private object SemanticsTreeBuilderAccess {
    fun build(root: LayoutNode) =
        com.awakekt.awake.compose.ui.semantics.SemanticsTreeBuilder().build(root)
}
