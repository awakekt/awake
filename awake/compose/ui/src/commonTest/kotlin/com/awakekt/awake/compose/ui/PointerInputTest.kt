...
class GestureAcrossFramesTest {
    ...
    private fun host() = com.awakekt.awake.compose.ui.platform.ComposeHost()
    ...
    fun hostDeliversConcurrentTouchContacts() {
        ...
        fun frame(vararg touches: com.awakekt.awake.compose.ui.platform.PointerFrame) {
            host.frame(
                com.awakekt.awake.compose.ui.platform.FrameInput(
                    viewportWidth = 200,
                    viewportHeight = 200,
        ...
        frame()
        frame(
            com.awakekt.awake.compose.ui.platform.PointerFrame(1, 5, 5, down = true),
            com.awakekt.awake.compose.ui.platform.PointerFrame(2, 6, 6, down = true),
        )
        frame(
            com.awakekt.awake.compose.ui.platform.PointerFrame(1, 15, 5, down = true),
            com.awakekt.awake.compose.ui.platform.PointerFrame(2, 16, 6, down = true),
        )
