...
import io.github.ronjunevaldoz.awake.compose.ui.node.NodeChildren
...
private object PassThroughNode : LayoutModifierNode {
...
class ModifierDefaultsTest {
    ...
    private fun node(): LayoutNode = LayoutNode(FixedPolicy(30, 20)).also {
        it.modifier = Modifier then PassThroughNode
    }
