...
import io.github.awakelab.awake.physics.DistanceConstraint
...
import io.github.awakelab.awake.physics.toMeshShape
import io.github.awakelab.awake.physics.requireCanBeSensor
...
class JoltPhysicsWorld(
    ...
    override fun shapeCast(
        ...
        try {
            ...
            start.col[0].apply { x = 1f; y = 0f; z = 0f; w = 0f }
            start.col[1].apply { x = 0f; y = 1f; z = 0f; w = 0f }
            start.col[2].apply { x = 0f; y = 0f; z = 1f; w = 0f }
    ...
    override fun overlapShape(
        ...
        try {
            ...
            transform.col[0].apply { x = 1f; y = 0f; z = 0f; w = 0f }
            transform.col[1].apply { x = 0f; y = 1f; z = 0f; w = 0f }
            transform.col[2].apply { x = 0f; y = 0f; z = 1f; w = 0f }
