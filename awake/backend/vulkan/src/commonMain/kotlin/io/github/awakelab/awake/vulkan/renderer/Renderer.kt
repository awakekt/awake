...
import io.github.awakelab.awake.render.passes.SharedOpaqueRenderFeature
...
import io.github.awakelab.awake.vulkan.pipeline.VulkanCommandRecorder
 ...
 * [io.github.awakelab.awake.vulkan.commands.TransferContext] instance: it only needs
...
class Renderer internal constructor(
     ...
     * [DrawCall.mesh]'s own [io.github.awakelab.awake.render.mesh.Mesh.format]; a format
