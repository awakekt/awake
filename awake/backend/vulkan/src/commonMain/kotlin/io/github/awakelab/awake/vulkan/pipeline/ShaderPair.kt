 ...
 * ([RenderPipeline], [io.github.awakelab.awake.vulkan.debug.LineRenderPipeline], and
 * [io.github.awakelab.awake.vulkan.renderer.Renderer]'s 4 UI pipelines). All of those
