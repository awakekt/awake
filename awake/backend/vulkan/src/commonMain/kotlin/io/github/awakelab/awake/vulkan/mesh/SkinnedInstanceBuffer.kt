...
import io.github.awakelab.awake.vulkan.handles.DescriptorPoolHandle
import io.github.awakelab.awake.vulkan.handles.DescriptorSetHandle
 ...
 *   [io.github.awakelab.awake.vulkan.material.Material]'s set. That set (set 0) is shared
...
class SkinnedInstanceBuffer(
    ...
    companion object {
        ...
        const val MAX_JOINTS = io.github.awakelab.awake.render.renderer.MAX_JOINTS
