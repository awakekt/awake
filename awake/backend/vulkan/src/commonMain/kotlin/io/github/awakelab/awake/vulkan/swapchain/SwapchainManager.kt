...
import io.github.awakelab.awake.vulkan.enums.VkSharingMode
import io.github.awakelab.awake.vulkan.enums.flags.VkFenceCreateFlagBits
import io.github.awakelab.awake.vulkan.has
...
import io.github.awakelab.awake.vulkan.utils.querySwapChainSupport
...
class SwapchainManager(
     ...
     * [RenderPipeline][io.github.awakelab.awake.vulkan.pipeline.RenderPipeline]/
     * [OffscreenRenderTarget][io.github.awakelab.awake.vulkan.texture.OffscreenRenderTarget]
    ...
    /** Deliberately prefers `_UNORM` formats, not `_SRGB` -- every [io.github.awakelab
