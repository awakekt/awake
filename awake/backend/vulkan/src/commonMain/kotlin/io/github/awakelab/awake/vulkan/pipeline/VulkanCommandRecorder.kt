...
import io.github.awakelab.awake.render.command.BufferHandle as RenderBufferHandle
...
internal class VulkanCommandRecorder : CommandRecorder {
    ...
    override fun setScissor(x: Int, y: Int, width: Int, height: Int) {
        Vulkan.vkCmdSetScissor(
            ...
            0,
            arrayOf(
                io.github.awakelab.awake.vulkan.models.VkRect2D(
                    offset = io.github.awakelab.awake.vulkan.models.VkOffset2D(x = x, y = y),
                    extent = io.github.awakelab.awake.vulkan.models.VkExtent2D(width = width, height = height),
                ),
            ),
        )
    }
