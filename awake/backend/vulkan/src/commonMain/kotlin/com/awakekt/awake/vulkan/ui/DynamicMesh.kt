...
/**
 * A vertex+index buffer rewritten every frame -- unlike [com.awakekt.awake
...
class DynamicMesh(
     ...
     * [com.awakekt.awake.core.graphics2d.UiDrawPrimitive.Quad]s (2 floats position + 4 floats
     * color per vertex).
     *
