...
class SwapchainManagerTest {
    ...
    @Test
    fun zeroSizedVariableExtentDefersSwapchainRecreation() {
        val manager = swapchainManagerWithExtent(width = 0, height = 1080)

        assertEquals(false, manager.hasDrawableExtent())
    }
