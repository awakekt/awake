 ...
 * io.github.awakelab.awake.vulkan.Vulkan. Kept in a separate package/object
...
expect object VulkanBuffers {
    ...
    /** `indexType` uses the plain-`Int` [io.github.awakelab.awake.vulkan.models.info.VkIndexType] values. */
