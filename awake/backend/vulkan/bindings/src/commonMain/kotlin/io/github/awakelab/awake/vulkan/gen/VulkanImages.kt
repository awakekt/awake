...
expect object VulkanImages {
     ...
     * [io.github.awakelab.awake.vulkan.models.info.VkImageLayout2] values `oldLayout`/`newLayout`.
     * `levelCount` defaults to `1` (every pre-existing caller is single-mip); a multi-mip
     * [io.github.awakelab.awake.vulkan.texture.Texture] must pass its real level count --
