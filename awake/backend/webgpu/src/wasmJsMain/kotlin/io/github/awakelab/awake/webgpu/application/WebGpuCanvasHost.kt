 ...
 */
package io.github.awakelab.awake.webgpu.application
...
val DefaultDomGameplayKeys: Map<String, io.github.awakelab.awake.core.input.Key> = linkedMapOf(
    "w" to io.github.awakelab.awake.core.input.Key.W,
    "a" to io.github.awakelab.awake.core.input.Key.A,
    "s" to io.github.awakelab.awake.core.input.Key.S,
    "d" to io.github.awakelab.awake.core.input.Key.D,
    "arrowup" to io.github.awakelab.awake.core.input.Key.ArrowUp,
    "arrowdown" to io.github.awakelab.awake.core.input.Key.ArrowDown,
    "arrowleft" to io.github.awakelab.awake.core.input.Key.ArrowLeft,
    "arrowright" to io.github.awakelab.awake.core.input.Key.ArrowRight,
    " " to io.github.awakelab.awake.core.input.Key.Space,
    "spacebar" to io.github.awakelab.awake.core.input.Key.Space,
    "escape" to io.github.awakelab.awake.core.input.Key.Escape,
    "f1" to io.github.awakelab.awake.core.input.Key.F1,
    "f2" to io.github.awakelab.awake.core.input.Key.F2,
    "f3" to io.github.awakelab.awake.core.input.Key.F3,
    "f4" to io.github.awakelab.awake.core.input.Key.F4,
    "f5" to io.github.awakelab.awake.core.input.Key.F5,
)
...
fun bindWindowKeyboardInput(
    input: Input,
    keys: Map<String, io.github.awakelab.awake.core.input.Key> = DefaultDomGameplayKeys,
) {
    fun resolveKey(event: KeyboardEvent): io.github.awakelab.awake.core.input.Key? =
...
private val DomEditKeys: Map<String, io.github.awakelab.awake.core.input.TextEditAction> =
    mapOf(
        "Backspace" to io.github.awakelab.awake.core.input.TextEditAction.Backspace,
        "Delete" to io.github.awakelab.awake.core.input.TextEditAction.Delete,
        "Enter" to io.github.awakelab.awake.core.input.TextEditAction.Enter,
        "ArrowLeft" to io.github.awakelab.awake.core.input.TextEditAction.ArrowLeft,
        "ArrowRight" to io.github.awakelab.awake.core.input.TextEditAction.ArrowRight,
        "ArrowUp" to io.github.awakelab.awake.core.input.TextEditAction.ArrowUp,
        "ArrowDown" to io.github.awakelab.awake.core.input.TextEditAction.ArrowDown,
        "Home" to io.github.awakelab.awake.core.input.TextEditAction.Home,
        "End" to io.github.awakelab.awake.core.input.TextEditAction.End,
    )
 ...
 * it, like [io.github.awakelab.awake.webgpu.texture.OffscreenRenderTarget]) is configured with.
 */
