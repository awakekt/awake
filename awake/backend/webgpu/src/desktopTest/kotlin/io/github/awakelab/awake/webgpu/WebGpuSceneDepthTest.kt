...
class WebGpuSceneDepthTest {
    ...
    fun aShaderSamplesTheDepthOfTheSceneInFrontOfIt() = withSceneDepthRenderer { renderer ->
        ...
        var nearMesh: io.github.awakelab.awake.render.mesh.Mesh? = null
        var farMesh: io.github.awakelab.awake.render.mesh.Mesh? = null
    ...
    private companion object {
        ...
        suspend fun uiSources() = io.github.awakelab.awake.webgpu.pipeline.UiShaderSources(
        ...
        suspend fun io.github.awakelab.awake.asset.shaders.ShaderStages.wgslBytes(): ByteArray =
