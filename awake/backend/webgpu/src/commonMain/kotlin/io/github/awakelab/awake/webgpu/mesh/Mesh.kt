...
import io.github.awakelab.awake.webgpu.handles.BufferHandle
import io.github.awakelab.awake.webgpu.handles.DeviceMemoryHandle
...
class Mesh(
    ...
    override val sizeBytes: Long =
        vertices.size.toLong() * Float.SIZE_BYTES + indices.size.toLong() * Int.SIZE_BYTES
