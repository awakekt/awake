 ...
 */
package io.github.awakelab.awake.webgpu.swapchain
 ...
 * and `renderingContext.width`/`.height` directly (see [io.github.awakelab.awake.webgpu.renderer.Renderer.draw]).
 */
