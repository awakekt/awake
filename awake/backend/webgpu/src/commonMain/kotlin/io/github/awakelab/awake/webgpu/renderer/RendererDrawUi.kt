...
import io.github.awakelab.awake.render.passes2d.SharedUiRenderFeature
...
import io.github.awakelab.awake.webgpu.pipeline.WebGpuUiRunRecorder
...
internal fun Renderer.performCompositeUiTargets(
    ...
    val pipeline = uiTargetCompositePipelines.getOrPut(mode) {
        io.github.awakelab.awake.webgpu.ui.UiTargetCompositePipeline(
            graphicsDevice,
            swapchainManager,
