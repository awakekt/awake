 ...
 * [io.github.awakelab.awake.vulkan.texture.Texture], minus that one's staging
 ...
 *
 * Uploads a full mip chain (see [io.github.awakelab.awake.render.texture.mipChain] --
 * backend-neutral CPU box-filter downsampling, the same generator
 * [io.github.awakelab.awake.vulkan.texture.Texture] uses) rather than just the base level,
