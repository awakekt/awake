...
import io.github.awakelab.awake.asset.shaders.RenderCapabilities
...
import io.github.awakelab.awake.webgpu.pipeline.WebGpuPipelineFactory
import io.github.awakelab.awake.webgpu.pipeline.WebGpuShaderResolver
...
import io.github.awakelab.awake.webgpu.renderer.Renderer
import io.github.awakelab.awake.webgpu.swapchain.SwapchainManager
import io.github.awakelab.awake.webgpu.texture.Texture
import io.github.awakelab.awake.asset.shaders.ShaderStage as ShaderProgramStage
...
open class WebGpuEngine(
    ...
    override suspend fun createBackendResources(window: Any): BackendResources {
        ...
        val pipelineTable = io.github.awakelab.awake.webgpu.pipeline.PipelineTable(
        ...
        val uiShaderSources: io.github.awakelab.awake.webgpu.pipeline.UiShaderSources =
            uiShaderSet { it.wgsl() }
