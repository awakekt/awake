...
class Mesh(
    ...
    override fun bind(commandBuffer: Long) {
        TODO("WebGPU binds vertex/index buffers directly in Renderer.draw(), see docs/mvp-plan.md")
    }

    override fun draw(commandBuffer: Long) {
        TODO("WebGPU issues drawIndexed directly in Renderer.draw(), see docs/mvp-plan.md")
    }
