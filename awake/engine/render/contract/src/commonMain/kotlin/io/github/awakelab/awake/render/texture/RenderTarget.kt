 ...
 * Narrow by design, like [io.github.awakelab.awake.render.mesh.Mesh]/
 * [io.github.awakelab.awake.render.material.Material] -- no raw GPU handle (VkImage/
 ...
 * back into other [io.github.awakelab.awake.render.renderer.Renderer] methods.
 */
interface RenderTarget {
    val width: Int
    val height: Int

    /** [io.github.awakelab.awake.render.renderer.Renderer] also tracks every
