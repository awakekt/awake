 ...
 * [io.github.awakelab.awake.render.mesh.Mesh.drawInstanced]. [model]/[extraUniformFloats]
...
data class DrawCall(
    ...
    /** Frame time paired with [vertexAnimation], written to its uniform padding slot. */
