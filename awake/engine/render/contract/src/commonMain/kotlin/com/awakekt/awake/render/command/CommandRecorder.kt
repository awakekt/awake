 ...
 * duration of a pass and never touches the concrete Vulkan/WebGPU type underneath. It lives in
 * the render contract because it is a hardware boundary; render passes consume it but do not own
 * the driver-facing vocabulary.
 *
 ...
 *   already-shipped `DepthPrePassFeature` refactor established.
