...
class TexturedUniformsTest {
    ...
    private class FakeMesh : com.awakekt.awake.render.mesh.Mesh {
        override val format = com.awakekt.awake.core.geometry.VertexFormat.PositionNormalColorUv
        override val sizeBytes: Long = 0
        override fun destroy() = Unit
    }

    private class FakeMaterial : com.awakekt.awake.render.material.Material {
