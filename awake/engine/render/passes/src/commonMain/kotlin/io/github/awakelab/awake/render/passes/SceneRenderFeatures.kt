...
import io.github.awakelab.awake.render.renderer.MOON_DISC_COLOR
import io.github.awakelab.awake.render.renderer.SUN_DISC_COLOR
import io.github.awakelab.awake.render.renderer.SkyboxFields
 ...
 * split [io.github.awakelab.awake.render.command.CommandRecorder] already uses, extended to
...
class SkyboxRenderFeature(
    ...
    override fun recordCommands(context: RenderFrameContext): Unit = with(context) {
        ...
        shared.recordCommands(
            recorder = recorder,
            pipeline = pipeline,
            uniformBinding = uniforms.binding(frameIndex),
        )
    }
