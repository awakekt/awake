...
import io.github.ronjunevaldoz.awake.core.graphics2d.ColoredTriangleMesh
import io.github.ronjunevaldoz.awake.core.graphics2d.ColoredVertex
...
import io.github.ronjunevaldoz.awake.core.graphics2d.DrawTransform
...
import io.github.ronjunevaldoz.awake.core.graphics2d.convexClipContour
...
object DrawRunCoalescer {
    ...
    fun buildTextureRun(
        ...
        val primitives = textures.map { primitive ->
            ...
            TexturedDrawRun(primitive.material, vertices, indices)
        }
        return StagedDrawRun.TextureRun(primitives)
    }

    fun tessellateStrokedPath(
        primitive: DrawCommand.StrokedPath,
        activePathClips: List<DrawPath>,
        safeInteriorRect: Rectangle?,
    ): Pair<TriangleMesh, Color> {
        val rawBounds = primitive.path.bounds()
        val strokeMargin = primitive.stroke.width.value
        val paintedBounds = Rectangle(
