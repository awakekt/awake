 ...
 */
package io.github.awakelab.awake.engine.bootstrap
...
import io.github.awakelab.awake.engine.bootstrap.dsl.createApp
import io.github.awakelab.awake.engine.bootstrap.dsl.createAppSpec
...
private object TutorialRenderer : Renderer {
    ...
    override fun createMesh(geometry: MeshGeometry): Mesh = object : Mesh {
        override val format: io.github.awakelab.awake.core.geometry.VertexFormat =
            geometry.format
