        ...
        val output = compositor.composite(
            ...
            layers = listOf(
                GraphicsLayerFrame(
                    ...
                    effectInsetX = 3,
                    effectInsetY = 3,
                    primitives = listOf(UiDrawPrimitive.FilledPath(DrawPath.build { moveTo(10f, 0f); lineTo(20f, 20f); lineTo(0f, 20f); close() }, Color.Black)),
                ),
            ),
            font = UiFonts.default(),
            viewportWidth = 80,
...
private class RecordingCompositeRenderer : NoopRenderer() {
    ...
    override fun drawUiToTexture(target: RenderTarget, primitives: List<UiDrawPrimitive>, font: io.github.awakelab.awake.core.text.font.UiFont?) {
        offscreenDraws += 1
    }
