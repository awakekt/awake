 ...
 */
object Frustum {
    fun corners(camera: Lens, aspect: Float): List<io.github.ronjunevaldoz.awake.core.math.Vec3f> {
...
private fun planeThrough(
    a: io.github.ronjunevaldoz.awake.core.math.Vec3f,
    b: io.github.ronjunevaldoz.awake.core.math.Vec3f,
    c: io.github.ronjunevaldoz.awake.core.math.Vec3f
): Plane? {
