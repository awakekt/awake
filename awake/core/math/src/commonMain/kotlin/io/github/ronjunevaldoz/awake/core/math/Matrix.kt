...
class Mat4 {
    ...
    /** Overwrites this matrix with a uniform [scale] followed by a translation to ([x], [y],
     ...
     */
    fun rotate(angle: Float, axis: io.github.ronjunevaldoz.awake.core.math.Vec3f): Mat4 {
    ...
    companion object {
        ...
        fun frustum(
            ...
            return Mat4().apply {
                ...
                m32 = -1.0f
                m23 =
                    if (clipSpace.depthZeroToOne) -far * near / depth else -2.0f * far * near / depth
                m33 = 0f
            }
        }
        ...
        fun perspective(
            ...
            return Mat4().apply {
                ...
                m32 = -1f
                m23 =
                    if (clipSpace.depthZeroToOne) near * far / rangeInv else 2f * near * far / rangeInv
                m33 = 0f
            }
        }
        ...
        fun setLookAt(
            eye: io.github.ronjunevaldoz.awake.core.math.Vec3f,
            center: io.github.ronjunevaldoz.awake.core.math.Vec3f,
            up: io.github.ronjunevaldoz.awake.core.math.Vec3f,
        ): Mat4 = Mat4().apply {
        ...
        fun fromTrs(
            translation: io.github.ronjunevaldoz.awake.core.math.Vec3f,
            rotation: Quat,
            scale: io.github.ronjunevaldoz.awake.core.math.Vec3f
        ): Mat4 {
...
/**
 * Elementwise sum -- `result[i] = this[i] + other[i]`.
 *
 * Matrix addition has no inner product, unlike [times]. This previously ran [times]'s triple
 * loop with `*` swapped for `+`, which summed `a[i,k] + b[k,j]` over k and made every entry of
 * `identity + identity` equal 2.
 */
