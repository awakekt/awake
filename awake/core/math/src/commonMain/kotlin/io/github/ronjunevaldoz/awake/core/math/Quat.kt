...
import io.github.ronjunevaldoz.awake.core.math.Quat.Companion.IDENTITY
import io.github.ronjunevaldoz.awake.core.math.Quat.Companion.fromEuler
...
data class Quat(var x: Float = 0f, var y: Float = 0f, var z: Float = 0f, var w: Float = 1f) {
    ...
    companion object {
        ...
        fun fromAxisAngle(
            ...
            if (length < DEGENERATE_AXIS_LENGTH) return Quat(
                IDENTITY.x,
                IDENTITY.y,
                IDENTITY.z,
                IDENTITY.w
        ...
        fun nlerp(a: Quat, b: Quat, t: Float): Quat {
            ...
            return if (length == 0f) IDENTITY else Quat(
                rx / length,
                ry / length,
                rz / length,
                rw / length
