 ...
 */
class Lens(
    var eye: io.github.ronjunevaldoz.awake.core.math.Vec3f,
    var center: io.github.ronjunevaldoz.awake.core.math.Vec3f,
    var up: io.github.ronjunevaldoz.awake.core.math.Vec3f = Vec3f(0f, 1f, 0f),
    ...
    companion object {
         ...
         */
        fun perspective(
            eye: io.github.ronjunevaldoz.awake.core.math.Vec3f = Vec3f(
                0f,
                0f,
                DEFAULT_EYE_DISTANCE
            ),
            center: io.github.ronjunevaldoz.awake.core.math.Vec3f = Vec3f.ZERO,
            up: io.github.ronjunevaldoz.awake.core.math.Vec3f = Vec3f.UP,
...
fun Lens.projectToViewport(
    world: io.github.ronjunevaldoz.awake.core.math.Vec3f,
    viewProjection: Mat4,
    viewportWidth: Float,
...
private fun Lens.isInFront(world: io.github.ronjunevaldoz.awake.core.math.Vec3f): Boolean {
...
fun Lens.rayThroughViewport(
    ...
    return if (dx * dx + dy * dy + dz * dz < DEGENERATE_LENGTH) null else Ray.through(
        nearPoint,
        farPoint
    )
}
...
private fun Mat4.unprojectNdc(
    ...
    ndcY: Float,
    ndcZ: Float
): io.github.ronjunevaldoz.awake.core.math.Vec3f? {
