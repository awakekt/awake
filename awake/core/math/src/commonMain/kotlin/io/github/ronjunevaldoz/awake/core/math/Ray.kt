 ...
 */
data class Ray(
    val origin: io.github.ronjunevaldoz.awake.core.math.Vec3f,
    val direction: io.github.ronjunevaldoz.awake.core.math.Vec3f
) {
    ...
    fun pointAt(distance: Float): io.github.ronjunevaldoz.awake.core.math.Vec3f = Vec3f(
    ...
    companion object {
        ...
        fun through(
            from: io.github.ronjunevaldoz.awake.core.math.Vec3f,
            to: io.github.ronjunevaldoz.awake.core.math.Vec3f
        ): Ray =
