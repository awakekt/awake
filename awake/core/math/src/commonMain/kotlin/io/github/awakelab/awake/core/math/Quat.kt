...
import io.github.awakelab.awake.core.math.Quat.Companion.IDENTITY
import io.github.awakelab.awake.core.math.Quat.Companion.fromEuler
 ...
 * quaternion-to-rotation-matrix formula [GltfParser][io.github.awakelab.awake.asset.gltf.GltfParser]'s
...
data class Quat(var x: Float = 0f, var y: Float = 0f, var z: Float = 0f, var w: Float = 1f) {
    ...
    /**
     * This rotation as the `(x, y, z)` radians [io.github.awakelab.awake.scene.core]'s
