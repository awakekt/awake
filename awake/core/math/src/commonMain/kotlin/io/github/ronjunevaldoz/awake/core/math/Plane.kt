 ...
 */
data class Plane(val normal: io.github.ronjunevaldoz.awake.core.math.Vec3f, val distance: Float) {
    ...
    fun signedDistanceTo(point: io.github.ronjunevaldoz.awake.core.math.Vec3f): Float =
        normal.x * point.x + normal.y * point.y + normal.z * point.z + distance

    fun project(point: io.github.ronjunevaldoz.awake.core.math.Vec3f): io.github.ronjunevaldoz.awake.core.math.Vec3f {
    ...
    companion object {
        ...
        fun through(
            point: io.github.ronjunevaldoz.awake.core.math.Vec3f,
            normal: io.github.ronjunevaldoz.awake.core.math.Vec3f
        ): Plane {
            val length = sqrt(normal.x * normal.x + normal.y * normal.y + normal.z * normal.z)
            require(length > EPSILON) { "A plane needs a normal, got $normal." }
