 ...
 */
data class Aabb(
    val min: io.github.awakelab.awake.core.math.Vec3f,
    val max: io.github.awakelab.awake.core.math.Vec3f,
) {

    val center: io.github.awakelab.awake.core.math.Vec3f
        get() = Vec3f(
            (min.x + max.x) * HALF,
            (min.y + max.y) * HALF,
            (min.z + max.z) * HALF,
    ...
    val extents: io.github.awakelab.awake.core.math.Vec3f
        get() = Vec3f(
            (max.x - min.x) * HALF,
            (max.y - min.y) * HALF,
            (max.z - min.z) * HALF,
    ...
    operator fun contains(point: io.github.awakelab.awake.core.math.Vec3f): Boolean =
    ...
    fun corners(): List<io.github.awakelab.awake.core.math.Vec3f> =
