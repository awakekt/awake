...
object Grid {
    ...
    fun lines(
        ...
        divisions: Int,
        y: Float = 0f
    ): List<Pair<io.github.ronjunevaldoz.awake.core.math.Vec3f, io.github.ronjunevaldoz.awake.core.math.Vec3f>> {
        require(divisions >= 1) { "divisions must be >= 1, was $divisions" }
        val half = size / 2f
        val step = size / divisions
        val result =
            ArrayList<Pair<io.github.ronjunevaldoz.awake.core.math.Vec3f, io.github.ronjunevaldoz.awake.core.math.Vec3f>>(
                (divisions + 1) * 2
            )
