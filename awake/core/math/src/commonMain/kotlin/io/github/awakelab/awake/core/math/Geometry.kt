 ...
 * x/y/z-per-vertex array, e.g. [io.github.awakelab.awake.asset.gltf.GltfMesh
 ...
 */
fun boundingCenter(positions: FloatArray): io.github.awakelab.awake.core.math.Vec3f {
    if (positions.size < POSITION_COMPONENTS) return Vec3f(0f, 0f, 0f)
    ...
    return Vec3f((minX + maxX) / 2f, (minY + maxY) / 2f, (minZ + maxZ) / 2f)
}
