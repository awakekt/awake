...
class Mat4 {
     ...
     */
    fun setTrs(
        translation: com.awakekt.awake.core.math.Vec3f,
        rotation: Quat,
        scale: com.awakekt.awake.core.math.Vec3f,
    ): Mat4 {
     ...
     */
    fun rotate(angle: Float, axis: com.awakekt.awake.core.math.Vec3f): Mat4 {
    ...
    fun setEulerTRS(
        ...
        m01 = sy * (cosZ * sinY * sinX - sinZ * cosX)
        m11 = sy * (sinZ * sinY * sinX + cosZ * cosX)
        m21 = sy * (cosY * sinX)
        m31 = 0f

        m02 = sz * (cosZ * sinY * cosX + sinZ * sinX)
        m12 = sz * (sinZ * sinY * cosX - cosZ * sinX)
        m22 = sz * (cosY * cosX)
        m32 = 0f
    ...
    companion object {
        ...
        fun setLookAt(
            ...
            up: com.awakekt.awake.core.math.Vec3f,
        ): Mat4 = Mat4().apply {
