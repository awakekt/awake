...
class Lens(
    ...
    var center: com.awakekt.awake.core.math.Vec3f,
    var up: com.awakekt.awake.core.math.Vec3f = Vec3f(0f, 1f, 0f),
    ...
    companion object {
         ...
         */
        fun perspective(
            eye: com.awakekt.awake.core.math.Vec3f = Vec3f(
                0f,
                0f,
                DEFAULT_EYE_DISTANCE,
            ),
            center: com.awakekt.awake.core.math.Vec3f = Vec3f.ZERO,
            up: com.awakekt.awake.core.math.Vec3f = Vec3f.UP,
...
private fun Lens.isInFront(world: com.awakekt.awake.core.math.Vec3f): Boolean {
...
private fun Mat4.unprojectNdc(
    ...
    ndcY: Float,
    ndcZ: Float,
): com.awakekt.awake.core.math.Vec3f? {
