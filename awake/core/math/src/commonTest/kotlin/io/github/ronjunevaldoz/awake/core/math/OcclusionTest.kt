...
class OcclusionTest {
    ...
    private fun Lens.viewProjection(aspect: Float = 1f) =
        viewProjectionMatrix(aspect, ClipSpace.WebGpu)
    ...
    fun isOccludedByIsTrueWhenCandidateIsFullyInsideAFartherOccluder() {
        val occluder =
            ScreenBounds(minX = 0f, minY = 0f, maxX = 1f, maxY = 1f, nearestDistance = 2f)
        val candidate =
            ScreenBounds(minX = 0.4f, minY = 0.4f, maxX = 0.6f, maxY = 0.6f, nearestDistance = 5f)
    ...
    fun isOccludedByIsFalseWhenCandidateOnlyPartiallyOverlapsTheOccluderRect() {
        val occluder =
            ScreenBounds(minX = 0f, minY = 0f, maxX = 1f, maxY = 1f, nearestDistance = 2f)
        val candidate =
            ScreenBounds(minX = 0.5f, minY = 0.5f, maxX = 1.5f, maxY = 1.5f, nearestDistance = 5f)
    ...
    fun isOccludedByIsFalseWhenCandidateIsNearerThanTheOccluder() {
        val occluder =
            ScreenBounds(minX = 0f, minY = 0f, maxX = 1f, maxY = 1f, nearestDistance = 5f)
        val candidate =
            ScreenBounds(minX = 0.4f, minY = 0.4f, maxX = 0.6f, maxY = 0.6f, nearestDistance = 2f)
    ...
    fun isOccludedByIsFalseWhenRectsDoNotOverlapAtAll() {
        val occluder =
            ScreenBounds(minX = 0f, minY = 0f, maxX = 1f, maxY = 1f, nearestDistance = 2f)
        val candidate =
            ScreenBounds(minX = 2f, minY = 2f, maxX = 3f, maxY = 3f, nearestDistance = 5f)
