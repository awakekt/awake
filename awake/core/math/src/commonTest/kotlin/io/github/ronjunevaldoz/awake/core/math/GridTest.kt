...
class GridTest {
    ...
    private fun assertVec3PairEquals(
        expectedStart: io.github.ronjunevaldoz.awake.core.math.Vec3f,
        expectedEnd: io.github.ronjunevaldoz.awake.core.math.Vec3f,
        actual: Pair<io.github.ronjunevaldoz.awake.core.math.Vec3f, io.github.ronjunevaldoz.awake.core.math.Vec3f>,
        epsilon: Float = 1e-4f
    ) {
