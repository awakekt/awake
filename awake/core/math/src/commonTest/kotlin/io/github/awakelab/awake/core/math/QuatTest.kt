...
class QuatTest {
    ...
    fun ninetyDegreeRotationsAboutEachAxisMoveTheBasisVectorsRightHanded() {
        ...
        assertVec4(
            Vec4(0f, 0f, 1f, 1f),
            Quat(half, 0f, 0f, half).toMat4().applyToColumnVector(0f, 1f, 0f),
        )
        assertVec4(
            Vec4(1f, 0f, 0f, 1f),
            Quat(0f, half, 0f, half).toMat4().applyToColumnVector(0f, 0f, 1f),
        )
        assertVec4(
            Vec4(0f, 1f, 0f, 1f),
            Quat(0f, 0f, half, half).toMat4().applyToColumnVector(1f, 0f, 0f),
        )
    }
    ...
    fun toMat4LeavesTheRotationAxisItselfUnmoved() {
        ...
        assertVec4(
            Vec4(0f, 1f, 0f, 1f),
            Quat(0f, half, 0f, half).toMat4().applyToColumnVector(0f, 1f, 0f),
        )
    }
    ...
    fun toMat4ProducesAnOrthonormalRotationThatPreservesLength() {
        ...
        assertApprox(Vec3f(1f, 2f, 3f).length3(), rotated.length3())
    ...
    fun nlerpResultIsAlwaysNormalized() {
        ...
        val length =
            sqrt(result.x * result.x + result.y * result.y + result.z * result.z + result.w * result.w)
