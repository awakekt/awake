...
class GeometryTest {
    ...
    fun centreOfAnEmptyArrayIsTheOrigin() {
        assertVec3(Vec3f(0f, 0f, 0f), boundingCenter(FloatArray(0)))
    }

    @Test
    fun centreOfATooShortArrayIsTheOrigin() {
        assertVec3(Vec3f(0f, 0f, 0f), boundingCenter(floatArrayOf(1f, 2f)))
    }

    @Test
    fun centreOfASinglePointIsThatPoint() {
        assertVec3(Vec3f(3f, -4f, 12f), boundingCenter(floatArrayOf(3f, -4f, 12f)))
    }
    ...
    fun centreOfASymmetricCloudIsTheOrigin() {
        ...
        assertVec3(Vec3f(0f, 0f, 0f), boundingCenter(positions))
    }
    ...
    fun centreOfAnAsymmetricCloudIsTheBoxMidpoint() {
        ...
        assertVec3(Vec3f(5f, 2f, -3f), boundingCenter(positions))
    }
    ...
    fun centreIsPerAxisSoOneStretchedAxisDoesNotMoveTheOthers() {
        ...
        assertVec3(Vec3f(0f, 1f, 1f), boundingCenter(positions))
    }
    ...
    fun centreIsTheBoxMidpointNotTheVertexAverage() {
        ...
        val vertexAverage =
            positions.filterIndexed { index, _ -> index % 3 == 0 }.average().toFloat()

        assertEquals(1f, vertexAverage, TOLERANCE)
        assertVec3(Vec3f(5f, 0f, 0f), boundingCenter(positions))
    }
    ...
    fun centreHandlesACloudEntirelyOnOneSideOfTheOrigin() {
        ...
        assertVec3(Vec3f(6f, 7f, 8f), boundingCenter(positions))
    }
    ...
    fun centreIgnoresATrailingPartialVertex() {
        ...
        assertVec3(Vec3f(5f, 2f, -3f), boundingCenter(ragged))
    }
