...
data class VertexFormat(val attributes: List<VertexAttribute>) {
    ...
    companion object {
         ...
         * [com.awakekt.awake.core.geometry.MeshGeometry] format so every pre-existing
         ...
         * drawn through one [com.awakekt.awake.render.renderer.Renderer] shares its
         ...
         * [com.awakekt.awake.asset.gltf.GltfMesh.toInterleavedSkinned]'s layout. */
         ...
         * [com.awakekt.awake.asset.gltf.GltfMesh.toInterleavedPositionNormalColorUv]'s
         * layout. */
