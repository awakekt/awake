 ...
 * per-frame [FrameLoop] delta and drains it in fixed-size [fixedDelta] steps (calling
 ...
 * [io.github.awakelab.awake.scene.systems.TransformSystem] only recomputes matrices
 ...
 * that wants it; today's [io.github.awakelab.awake.scene.systems.RenderSystem] ignores
