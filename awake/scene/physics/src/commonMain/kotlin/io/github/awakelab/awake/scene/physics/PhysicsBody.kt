 ...
 *
 * [handle] starts `null` and stays that way until [io.github.awakelab.awake.scene.physics.PhysicsSystem]
...
data class PhysicsBody(
    ...
    /**
     * Settable, because [io.github.awakelab.awake.scene.physics.PhysicsSystem] rebuilds the
