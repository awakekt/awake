 ...
 */
package io.github.awakelab.awake.scene.physics.components
 ...
 *
 * [handle] starts `null` and stays that way until [io.github.awakelab.awake.scene.physics.systems.PhysicsSystem]
