...
class SceneBehaviorComponentTest {
    ...
    fun patrolParametersSurviveTheRoundTrip() {
        ...
        val exported = SceneLoader.fromWorld(scene.world).nodes.single().components.single()
    ...
    fun aTargetNamingNothingIsRejected() {
        ...
        val failure = assertFailsWith<IllegalArgumentException> { SceneLoader.instantiate(document) }
    ...
    fun exportingAReferenceToAnUnnamedEntityFailsRatherThanDroppingIt() {
        ...
        assertFailsWith<IllegalArgumentException> { SceneLoader.fromWorld(world) }
    }
    ...
    fun fleeParametersSurviveTheRoundTrip() {
        ...
        val document = SceneLoader.fromWorld(world)
