...
class SceneLoaderTest {
    ...
    fun fromWorldExportsLocalTransformsComponentsAndHierarchy() {
        ...
        world.add(
            parent,
            Transform(position = com.awakekt.awake.core.math.Vec3f(1f, 2f, 3f)),
        )
        ...
        world.add(
            child,
            Transform(
                position = com.awakekt.awake.core.math.Vec3f(4f, 5f, 6f),
                parent = parent,
            ),
        )
        world.add(
            ...
            SceneCameraComponent(
                Lens(
                    eye = com.awakekt.awake.core.math.Vec3f(7f, 8f, 9f),
                    center = com.awakekt.awake.core.math.Vec3f(1f, 2f, 3f),
        ...
        world.add(
            child,
            Light(
                color = com.awakekt.awake.core.math.Vec3f(0.1f, 0.2f, 0.3f),
                intensity = 0.75f,
