 ...
 * [com.awakekt.awake.scene.rendering.RenderSystem3D]'s own doc comment on
 ...
 * many particles have ever been spawned, and [com.awakekt.awake.scene.rendering
 ...
 * color+alpha ([com.awakekt.awake.render.passes.RenderDrawCommand.instanceColors]) for
 ...
 * [com.awakekt.awake.scene.rendering.particles.ParticleSystem] the same way
...
class ParticleEmitter(
     ...
     * [com.awakekt.awake.scene.rendering.particles.ParticleSystem] checks before
    ...
    /** Reused every frame for `RenderDrawCommand.extraUniformFloats` (camera basis + frame info) --
     ...
     * [com.awakekt.awake.scene.rendering.particles.BurstEmitterPool] calls on an
 ...
 * for the common case: [com.awakekt.awake.scene.rendering.particles.ParticleSystem]
