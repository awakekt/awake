 ...
 * [WorldDebugSettings] -- kept separate from [RenderSystem3D] (which already does draw-call
 ...
 * rather than growing [RenderSystem3D.update] further. Run this after [RenderSystem3D] each frame
...
fun debugVisualizationLines(
    ...
    // RenderSystem3D.lastOccludedCount already gives a numeric "did this cull anything"
...
private val INSTANCE_BOUNDS_COLOR = Color(r = 0f, g = 0.8f, b = 1f, a = 1f)
