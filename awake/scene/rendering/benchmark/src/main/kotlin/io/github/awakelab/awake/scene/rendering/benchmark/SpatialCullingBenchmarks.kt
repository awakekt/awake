 ...
 */
package io.github.awakelab.awake.scene.rendering.benchmark
...
import io.github.awakelab.awake.scene.rendering.spatial.SpatialGrid
 ...
 *
 * [everyEntityTested] is what `RenderSystem` did before one existed: a frustum test per entity,
