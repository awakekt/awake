...
import com.awakekt.awake.scene.rendering.particles.currentFrame
...
class RenderSystem(
     ...
     * level verification, same reasoning [com.awakekt.awake.scene.rendering.debug.WorldDebugSettings]'s
     ...
     * frame) or [worldBounds] straddles the near plane (see [com.awakekt.awake.core.math.screenBounds]'s
    ...
    private fun isOccluded(
        ...
        worldBounds: com.awakekt.awake.core.math.Aabb,
