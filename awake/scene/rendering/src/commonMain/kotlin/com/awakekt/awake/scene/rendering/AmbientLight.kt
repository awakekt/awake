 ...
 *
 * Decoupled from [Environment] so global ambient fill can be authored, tweaked, or animated
 * independently of skybox or fog. Matches Godot's `ambient_light_*` / Unreal's `SkyLight`.
 *
