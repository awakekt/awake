...
import io.github.awakelab.awake.scene.rendering.components.BOUNCE_STOP_VELOCITY
import io.github.awakelab.awake.scene.rendering.components.BurstEmitterPool
import io.github.awakelab.awake.scene.rendering.components.Particle
import io.github.awakelab.awake.scene.rendering.components.ParticleEmitter
import io.github.awakelab.awake.scene.rendering.components.ParticleGround
 ...
 * destroyed once every particle it will ever spawn has died, so [io.github.awakelab.awake
...
class ParticleSystem : System {
     ...
     * path (see [io.github.awakelab.awake.scene.rendering.components.ParticleDynamics]'s
    ...
    /** Velocity resolution, in priority order -- see [io.github.awakelab.awake.scene
 ...
 * Read by [RenderSystem] to build [io.github.awakelab.awake.render.renderer.DrawCall
 ...
 * rather than in lockstep. Read by [RenderSystem] to build [io.github.awakelab.awake.render
 ...
 * [io.github.awakelab.awake.scene.rendering.components.ParticleMotion]'s own doc comment
