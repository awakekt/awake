 ...
 * `Aabb.fromPositions`. [RenderSystem][io.github.awakelab.awake.scene.rendering.systems.RenderSystem]
 * reads it into that entity's [Transform][io.github.awakelab.awake.scene.core.components.Transform]
