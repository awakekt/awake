...
/** [com.awakekt.awake.scene.rendering.RenderSystem] doesn't shade anything itself -- it just resolves the scene's [com.awakekt.awake.scene.rendering.Light] entity
 * (or [com.awakekt.awake.render.renderer.DEFAULT_SCENE_LIGHT] when there isn't one) into the backend-neutral [com.awakekt.awake.render.renderer.SceneLight]
