 ...
 *
 * Not the camera itself. That is `scene.rendering.components.Camera`, which holds the [Lens].
 * This was called `CameraComponent`, which read as "the camera's ECS component" and sent people
 * to the wrong type; a rig is the mount, not the optics.
 */
