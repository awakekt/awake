...
import io.github.awakelab.awake.scene.runtime.ui.sceneComposeAppModule
...
class SceneAppLifecycleDslTest {
    ...
    fun sceneAppProvidesTypedSystemsAndCachedAssets() = runTest {
        ...
        lateinit var tickSystem: io.github.awakelab.awake.scene.runtime.SceneSystemHandle<RecordingSystem>
        val game = app {
            ecs {
                name("runtime-proof")
                scene {
    ...
    fun explicitSystemPhasesSeparateFixedStepsFromRenderedFrames() = runTest {
        lateinit var fixedHandle: io.github.awakelab.awake.scene.runtime.SceneSystemHandle<RecordingSystem>
        lateinit var frameHandle: io.github.awakelab.awake.scene.runtime.SceneSystemHandle<RecordingSystem>
        val game = app {
            scene("phase-proof") {
                cameraEntity("camera")
