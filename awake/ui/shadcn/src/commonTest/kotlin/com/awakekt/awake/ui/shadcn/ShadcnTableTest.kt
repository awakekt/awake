...
import com.awakekt.awake.ui.shadcn.components.ShadcnTable
import com.awakekt.awake.ui.shadcn.components.ShadcnTableBody
import com.awakekt.awake.ui.shadcn.components.ShadcnTableCaption
import com.awakekt.awake.ui.shadcn.components.ShadcnTableCell
import com.awakekt.awake.ui.shadcn.components.ShadcnTableHead
import com.awakekt.awake.ui.shadcn.components.ShadcnTableHeader
import com.awakekt.awake.ui.shadcn.components.ShadcnTableRow
...
class ShadcnTableTest {
    ...
    fun aHeaderRowIs40AndABodyRowIs37() {
        val nodes = frame {
            ShadcnTable {
                ShadcnTableHeader {
                    ShadcnTableRow(com.awakekt.awake.compose.ui.Modifier.testTag("header-row")) {
            ...
            ShadcnTable {
                ShadcnTableBody {
                    row {
                        ShadcnTableCell(
                            "row",
                            modifier = com.awakekt.awake.compose.ui.Modifier.testTag("row"),
                        )
                    }
                }
                ShadcnTableCaption(
                    "A list of your recent invoices.",
                    com.awakekt.awake.compose.ui.Modifier.testTag("caption"),
                )
            }
        }
