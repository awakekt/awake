...
class ShadcnComposeRenderPreview {
    ...
    fun surfaceRendersBorderedRoundedCorner() {
        ...
        val frame = composeFrame(width, height) {
            provideShadcnTheme(theme) {
                com.awakekt.awake.ui.shadcn.components.shadcnSurface(
        ...
        val outline = frame.primitives
            .filterIsInstance<com.awakekt.awake.core.graphics2d.UiDrawPrimitive.Mesh>()
            .firstOrNull()
        ...
        val bounds = com.awakekt.awake.core.graphics2d.ColoredTriangleMesh(
