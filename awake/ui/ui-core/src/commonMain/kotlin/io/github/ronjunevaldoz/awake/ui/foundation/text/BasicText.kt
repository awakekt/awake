...
public fun UiPrimitiveScope.drawTextBlock(
    label: String,
    slot: Rectangle,
    font: UiFont,
    color: Color?,
    ...
    fun emitLinesInternal(drawColor: Color) {
        var penY = when {
...
/**
 * Memoizes [layoutBitmapText] for [drawTextBlock]'s call shape specifically (the one call site
...
/** For a debug perf overlay (`AppUiRuntime.drawPerfStatsOverlay`) to report cache
...
public fun clearTextLayoutCache() {
