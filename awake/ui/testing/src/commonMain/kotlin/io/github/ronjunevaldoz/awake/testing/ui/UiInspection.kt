...
fun inspectUiFrame(
    ...
    val clipStack = ArrayDeque<io.github.ronjunevaldoz.awake.core.math2d.Rectangle>()

    fun currentClip(): io.github.ronjunevaldoz.awake.core.math2d.Rectangle = clipStack.lastOrNull() ?: frameSlot
    ...
    fun slotHasFiniteBounds(slot: io.github.ronjunevaldoz.awake.core.math2d.Rectangle): Boolean =
        slot.x.isFiniteCoordinate() &&
            slot.y.isFiniteCoordinate() &&
            slot.width.isFiniteCoordinate() &&
            slot.height.isFiniteCoordinate()

    fun slotHasValidSize(slot: io.github.ronjunevaldoz.awake.core.math2d.Rectangle): Boolean = slot.width >= 0f && slot.height >= 0f

    fun visibleOutsideFrame(slot: io.github.ronjunevaldoz.awake.core.math2d.Rectangle): Boolean {
    ...
    fun primitiveBounds(primitive: UiDrawPrimitive): io.github.ronjunevaldoz.awake.core.math2d.Rectangle? = when (primitive) {
        is UiDrawPrimitive.Quad -> io.github.ronjunevaldoz.awake.core.math2d.Rectangle(primitive.x, primitive.y, primitive.w, primitive.h)
        is UiDrawPrimitive.GradientQuad -> io.github.ronjunevaldoz.awake.core.math2d.Rectangle(primitive.x, primitive.y, primitive.w, primitive.h)
        is UiDrawPrimitive.RoundedQuad -> io.github.ronjunevaldoz.awake.core.math2d.Rectangle(primitive.x, primitive.y, primitive.w, primitive.h)
        is UiDrawPrimitive.Glyph -> io.github.ronjunevaldoz.awake.core.math2d.Rectangle(primitive.x, primitive.y, primitive.w, primitive.h)
        is UiDrawPrimitive.Texture -> io.github.ronjunevaldoz.awake.core.math2d.Rectangle(primitive.x, primitive.y, primitive.w, primitive.h)
...
private fun strokedPathBounds(path: UiPath, strokeWidthPx: Float): io.github.ronjunevaldoz.awake.core.math2d.Rectangle {
