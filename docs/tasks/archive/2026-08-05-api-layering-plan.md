...
Status: completed. Stable classifications live in
[`docs/reference/api-layering.md`](../../reference/api-layering.md); all five scene leaf modules in
the proposal now exist.
...
The source cleanup and scene split are complete:

1. `awake:ecs` remains the generic core; advanced hot-path APIs are documented explicitly.
...
5. Scene split proposal completed and archived in
   [docs/tasks/archive/2026-08-05-scene-module-split-proposal.md](2026-08-05-scene-module-split-proposal.md).
