# Changelog Archive (v0.1.0-dev.1 to v0.1.0-dev.7)

This archive documents historical pre-releases of Awake Engine.
For active releases and upcoming changes, see [CHANGELOG.md](../../CHANGELOG.md).
