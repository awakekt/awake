# Archived: DSL Modules

This document is retained for history only. It describes the deleted immediate-mode DSL module
layout and is not current API guidance.
