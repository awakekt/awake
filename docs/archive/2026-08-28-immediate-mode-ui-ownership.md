# Archived: Immediate-Mode UI Ownership

This document is retained for history only. The ownership model below was replaced by the
retained Compose module model in [`docs/reference/ui-ownership.md`](../reference/ui-ownership.md).
...
hatch. See `skills/awake-shadcn-recipe-consuming/SKILL.md` for the full skill.
