...
| `:awake:scene:scene3d`                        | Render-facing scene components and systems: `Camera`, `Light`, `MeshRenderer`, `RenderSystem3D`                                                                                                                                                                                      | not published |
...
| `:app:studio`                                   | The Awake Studio editor application: scene hierarchy, inspector, viewport docking. An application, not a sample -- see [D32](decisions/D32-editor-is-a-library.md)                                                                                                                 | application   |
