...
Usage:
    python3 tools/shadcn/capture_shadcn_local.py
    python3 tools/shadcn/capture_shadcn_local.py --only button-variants --theme both
"""
...
MANIFEST = REPO / "tools/shadcn/shadcn_reference_cases.json"
