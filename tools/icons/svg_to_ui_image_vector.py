...
Usage:
    python3 tools/icons/svg_to_ui_image_vector.py icon.svg --name chevronDown \
...
def emit_packed(name, viewport, blocks, dp, source, indent="    ", level=2):
    ...
    lines = []
    if source:
        lines.append(f"{i0}/** {source}, generated by tools/icons/svg_to_ui_image_vector.py -- do not hand-edit. */")
