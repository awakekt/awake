...
```bash
./gradlew :awake:ui:ui-core:desktopTest --tests "*UiFrameTimeProbeTest*" --rerun-tasks -i
```
```bash
./gradlew :awake:ui:ui-core:wasmJsBrowserTest --tests "*UiFrameTimeProbeTest*" --rerun-tasks
```
