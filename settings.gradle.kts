...
include(":awake:editor:core")
include(":awake:editor")
include(":awake:editor:scene")
include(":awake:editor:physics")
include(":awake:editor:ai")
include(":awake:editor:render")
...
// Applications: shipped products built on the libraries above, not illustrations of them.
include(":apps:studio")
