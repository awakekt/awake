...
`awake:backend:vulkan` source file. The ledger is intentionally empty. Scene lowering happens
in `render:passes`; Vulkan receives resolved `GpuPassInput` packets and hardware handles.
