...
import io.github.awakelab.awake.asset.shaderpack.TexturedUniformLayout
...
import io.github.awakelab.awake.core.math.boundingRadius
...
internal object GltfViewerAssets {
     ...
     * re-anchors the emitter's origin to the duck's own [io.github.awakelab.awake.scene
