...
/**
 * The heightfield showcase, rendered the way the app wires it.
 *
 * `ShowcasePlanFrameTest` already proves the terrain comes out lit. This is the other half: that
 * the scene's *other* objects reach the frame at all.
 */
